...
class DataCollector:
    def __init__(self):
        ...
        self.barometer = None
        self.barometer_temperature = None
    ...
    def write_to_csv(self):
        row = [
            ...
            self.barometer,
            self.barometer_temperature
        ]

        with open('data_raw.csv', 'a+', newline='') as csvfile:
...
class AccelerometerSensorMovementSensorMPU9250(MovementSensorMPU9250SubService):
    ...
    def cb_sensor(self, data):
        ...
        rawVals = data[3:6]
        self.data_collector.accelerometer = tuple([ v*self.scale for v in rawVals ])
        self.data_collector.output()
...
class MagnetometerSensorMovementSensorMPU9250(MovementSensorMPU9250SubService):
    ...
    def cb_sensor(self, data):
        ...
        rawVals = data[6:9]
        self.data_collector.magnetometer = tuple([ v*self.scale for v in rawVals ])
        self.data_collector.output()
...
class GyroscopeSensorMovementSensorMPU9250(MovementSensorMPU9250SubService):
    ...
    def cb_sensor(self, data):
        ...
        rawVals = data[0:3]
        self.data_collector.gyroscope = tuple([ v*self.scale for v in rawVals ])
        self.data_collector.output()
...
class OpticalSensor(Sensor):
    ...
    def callback(self, sender: int, data: bytearray):
        ...
        self.data_collector.optical = 0.01 * (m << e)
        self.data_collector.output()
...
class HumiditySensor(Sensor):
    ...
    def callback(self, sender: int, data: bytearray):
        ...
        self.data_collector.humidity = RH
        self.data_collector.humidty_temperature = temp
        self.data_collector.output()
...
class BarometerSensor(Sensor):
    ...
    def callback(self, sender: int, data: bytearray):
        ...
        self.data_collector.barometer = press
        self.data_collector.barometer_temperature = temp
...
async def run(address):
    async with BleakClient(address) as client:
        ...
        #humidity
        humidity_sensor = HumiditySensor(data_collector)
